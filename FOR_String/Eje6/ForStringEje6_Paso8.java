 ...
 * @author professor
 */
public class ForStringEje6_Paso8 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (frase.length() >= palabraBuscar.length() && frase.length() > 0) {
            ...
            //en esta parte del código ya sabemos si hemos encontrado la palabra a substituir
            //para facilitar el ejercicio se divide el ejercicio en:
            //a. encontrar la palabra
            //b. si se ha encontrado crear la frase final
